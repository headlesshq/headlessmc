...
public class JLineCommandLineReader implements CommandLineReader, SupportsHidingPasswords {
     ...
     */
    @Setter
    protected volatile @Nullable String readPrefix;
    ...
    public void read(Application hmc) throws IOError {
        ...
        try {
            ...
            String line;
            LineReader currentLineReader;
            while ((currentLineReader = lineReader) != null) {
                try {
